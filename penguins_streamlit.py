...
st.write(f"We predict your penguin is of the {prediction_species} species.")
st.write(
    """We used a machine learning (Random Forest) model to predict the species of the penguin, the features used in this prediction are ranked by relative importance below."""
)
